...
/*!40000 ALTER TABLE `tb_comment_topic` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_comment_topic` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_topic` (
  ...
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='主题表（或者说是文章）';
/*!40101 SET character_set_client = @saved_cs_client */;
